...
# Benchmark EfficientNet-Edge (efficientnet_es, efficientnet_em, efficientnet_el) using timm on real ImageNet subset images
...
# --- Argument Parser ---
parser = argparse.ArgumentParser(description='Benchmark EfficientNet-Edge inference speed and accuracy')
parser.add_argument('--model', type=str, default='efficientnet_es', help='EfficientNet-Edge variant: efficientnet_es, efficientnet_em, efficientnet_el')
