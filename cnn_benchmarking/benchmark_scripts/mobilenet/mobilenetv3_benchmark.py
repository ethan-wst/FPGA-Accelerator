...
# Benchmark pretrained MobileNetV3 (small/large) on random images from ImageNet_SubSet to measure inference speed and top-1/top-5 accuracy
...
# --- Argument Parser ---
parser = argparse.ArgumentParser(description='Benchmark MobileNetV3 inference speed and accuracy')
parser.add_argument('--model', type=str, default='mobilenet_v3_small', help='Model name: mobilenet_v3_small or mobilenet_v3_large')
